...
stargazer(Corolla["CarPrice"], type = "text", title="Summary statistics of Car Price",
...
var= Corolla[c("CarPrice","Age_08_04","KM","HP","cc","Doors","Gears","Quarterly_Tax","Weight")]
...
SubReg=regsubsets(CarPrice ~., data=training_data[, -c(1,2,5,6,8,11,15)], nbest=2) # chooses the best two models for each subset size 
